...
This package will add the following appSetting keys to your Web.config file: `HttpsRedirect:DocTypes`, `HttpsRedirect:PageIds`, `HttpsRedirect:Templates`, `HttpsRedirect:Properties`, `HttpsRedirect:StripPort` and `HttpsRedirect:UseTemporaryRedirects`.
